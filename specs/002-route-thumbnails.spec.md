...
- Metadata is published before each thumbnail is prepared; raw geometry is discarded after processing the file. Cache clearing invalidates pending writes from the current import without removing its on-screen images.
